...
mongoimport --drop --type csv --headerline -d East -c categories      --file "C:\NorthwindCSV\categories.csv"
mongoimport --drop --type csv --headerline -d East -c customers       --file "C:\NorthwindCSV\customers.csv"
mongoimport --drop --type csv --headerline -d East -c emp-territories --file "C:\NorthwindCSV\emp-territories.csv"
mongoimport --drop --type csv --headerline -d East -c employees       --file "C:\NorthwindCSV\employees.csv"
mongoimport --drop --type csv --headerline -d East -c order-details   --file "C:\NorthwindCSV\order-details.csv"
mongoimport --drop --type csv --headerline -d East -c orders          --file "C:\NorthwindCSV\orders.csv"
mongoimport --drop --type csv --headerline -d East -c products        --file "C:\NorthwindCSV\products.csv"
mongoimport --drop --type csv --headerline -d East -c regions         --file "C:\NorthwindCSV\regions.csv"
mongoimport --drop --type csv --headerline -d East -c shippers        --file "C:\NorthwindCSV\shippers.csv"
mongoimport --drop --type csv --headerline -d East -c suppliers       --file "C:\NorthwindCSV\suppliers.csv"
mongoimport --drop --type csv --headerline -d East -c territories     --file "C:\NorthwindCSV\territories.csv"
